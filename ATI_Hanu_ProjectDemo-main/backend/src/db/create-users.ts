...
async function createMissingUsers() {
  ...
  const s1 = { firstName: 'Linh', lastName: 'Nguyen', email: 'linh@example.com', department: 'Operations & Supply Chain', jobTitle: 'Operations Manager', location: 'Hanoi', role: 'staff' };
  ...
  const s2 = { firstName: 'An', lastName: 'Tran', email: 'an@example.com', department: 'Sales Department', jobTitle: 'Account Executive', location: 'Hanoi', role: 'staff' };
